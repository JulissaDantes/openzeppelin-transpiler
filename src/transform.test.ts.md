...
> Snapshot 1
    ...
    `pragma solidity ^0.6;␊
    ␊
    contract Foo {    function initialize(uint x) public virtual initializer {␊
            __Foo_init(x);␊
        }␊
    ␊
    ...
    ␊
    contract Bar {    function initialize() public virtual initializer {␊
            __Bar_init();␊
        }␊
    ␊
    }␊
...
> Snapshot 1
    ...
    `pragma solidity ^0.6;␊
    ␊
    contract FooWithArgs {    function initialize(uint x, uint y) public virtual initializer {␊
